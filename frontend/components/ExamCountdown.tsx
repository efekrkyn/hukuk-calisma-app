    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="flex items-baseline gap-4">
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular">{finals.days}</span>
            ...
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular">{finals.hours.toString().padStart(2, '0')}</span>
              <span className="text-xs text-muted-foreground uppercase tracking-widest mt-1">Saat</span>
            </div>
            <span className="text-2xl text-muted-foreground/30 font-light">:</span>
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular text-muted-foreground">{finals.minutes.toString().padStart(2, '0')}</span>
      ...
      <Card className="border-blue-500/20 shadow-sm relative overflow-hidden group">
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="flex items-baseline gap-4">
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular">{hmgs.days}</span>
              <span className="text-xs text-muted-foreground uppercase tracking-widest mt-1">Gün</span>
            </div>
            <span className="text-2xl text-muted-foreground/30 font-light">:</span>
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular">{hmgs.hours.toString().padStart(2, '0')}</span>
              <span className="text-xs text-muted-foreground uppercase tracking-widest mt-1">Saat</span>
            </div>
            <span className="text-2xl text-muted-foreground/30 font-light">:</span>
            <div className="flex flex-col items-center">
              <span className="text-3xl sm:text-4xl font-bold tracking-tighter nums-tabular text-muted-foreground">{hmgs.minutes.toString().padStart(2, '0')}</span>
              <span className="text-xs text-muted-foreground uppercase tracking-widest mt-1">Dk</span>
            </div>
          </div>
        </CardContent>
