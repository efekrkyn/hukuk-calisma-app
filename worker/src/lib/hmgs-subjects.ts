...
export type HmgsSubject = {
   ...
   * Boş dizi = korpusta karşılığı yok, bu alandan soru üretilemez.
   */
  lawFiles: string[];
};
...
export const HMGS_SUBJECTS: HmgsSubject[] = [
  ...
  { id: "anayasa_yargisi", name: "Anayasa Yargısı", percent: 2.5, count: 3, topic: "Anayasa Mahkemesi, iptal davası, bireysel başvuru", lawFiles: ["anayasa.pdf"] },
  { id: "idare", name: "İdare Hukuku", percent: 5, count: 6, topic: "idari işlem, idari sözleşme, kamu görevlileri, idarenin sorumluluğu", lawFiles: ["idari-yargilama-2577.pdf"] },
  ...
  { id: "ceza_yargilama", name: "Ceza Yargılama Usulü", percent: 5, count: 6, topic: "CMK 5271 soruşturma kovuşturma, koruma tedbirleri, kanun yolları", lawFiles: ["ceza-muhakemesi-5271.pdf"] },
  ...
  { id: "vergi", name: "Vergi Hukuku", percent: 2.5, count: 3, topic: "vergilendirme ilkeleri, vergi borcu, vergi suç ve cezaları", lawFiles: ["vergi-usul-213.pdf"] },
  { id: "vergi_usul", name: "Vergi Usul Hukuku", percent: 2.5, count: 3, topic: "VUK 213 tarh tebliğ tahakkuk tahsil, defter belge, süreler", lawFiles: ["vergi-usul-213.pdf"] },
  ...
  { id: "felsefe_sosyoloji", name: "Hukuk Felsefesi ve Sosyolojisi", percent: 2.5, count: 3, topic: "doğal hukuk, pozitivizm, adalet kuramları, hukuk sosyolojisi", lawFiles: [] },
  ...
  { id: "milletlerarasi", name: "Milletlerarası Hukuk", percent: 2.5, count: 3, topic: "devletler hukuku, andlaşmalar, uluslararası yargı organları", lawFiles: [] },
  ...
  { id: "genel_kamu", name: "Genel Kamu Hukuku", percent: 2.5, count: 3, topic: "devlet kuramı, egemenlik, insan hakları kuramı", lawFiles: [] },
];
